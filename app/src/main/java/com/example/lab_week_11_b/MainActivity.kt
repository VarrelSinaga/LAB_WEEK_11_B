...
class MainActivity : AppCompatActivity() {
    ...
    private fun openImageCapture() {
        // Generate URI dan informasi file baru
        val newPhotoInfo = providerFileManager.generatePhotoUri(System.currentTimeMillis())
        // Simpan informasi file ke variabel kelas
        photoInfo = newPhotoInfo
        // Gunakan 'let' untuk memastikan URI tidak null sebelum memanggil launch()
        newPhotoInfo.uri.let { uri ->
